    ...
    <div class="w-full py-10" x-data="{ pdfFile: null }">
        <form>
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">PDF file</label>
            ...
            <div id="pdf-preview-container" class="mt-4" x-show="pdfFile">
                ...
                <embed class="mt-2" :src="URL.createObjectURL(pdfFile)" type="application/pdf" width="100%" height="600px">
            </div>
